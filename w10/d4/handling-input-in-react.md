...
1. Try to add another input, "description" that works similarly to the above.
2. Ignoring the new "description" field, make the "add skill" button work.
...
#### Optional/Advanced stuff: Using a newSkill object.

#### 💪 Tricky Practice Exercise (10 min)
